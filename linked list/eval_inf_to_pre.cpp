...
int main()
{   
    string prefix_exp;stack_sll operand_stack;string str = "";
    cout<<"-----------------------IMPORTANT------------------------------------"<<endl;
    ...
    getline(cin, prefix_exp);
    float r; int c = prefix_exp.length();float n1;float n2;int i = c - 1;
    while (i >= 0)
    {
        ...
        else
        {
            ...
            operand_stack.pop();
            r = operation(n2,n1,prefix_exp[i]);
    ...
    cout<<"**************************OUTPUT**************************"<<endl;
    cout<<"Enterred Prefix expression :: "<<prefix_exp<<endl;
